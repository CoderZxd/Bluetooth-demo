...
public class BluCatUtil {
	...
	public static void doctorDevice() throws BluetoothStateException {
		...
		if (!LocalDevice.isPowerOn()) {
			...
			System.out.println("Bluetooth Adaptor powered on");
		}
		...
		try {
			String result = "";
			String[] deviceprops = { "bluetooth.api.version", "bluetooth.master.switch", "bluetooth.sd.attr.retrievable.max", "bluetooth.connected.devices.max", "bluetooth.l2cap.receiveMTU.max",
					"bluetooth.sd.trans.max", "bluetooth.connected.inquiry.scan", "bluetooth.connected.page.scan", "bluetooth.connected.inquiry", "bluetooth.connected.page" };
